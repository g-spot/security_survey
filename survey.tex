...
\\
Now we take a look at one specific topic namely Automotive Environments (A-ENV). In \cite{DBLP:conf/automotiveSS/JakobKSGMSF12} a approach to generate test cases for risk-based testing in A-ENV is planned and demonstrated. 

Another approach is described in \cite{DBLP:journals/esl/DardanelliMTZSKH13}:
\begin{quote}
"In this letter, a hierarchically distributed control system architecture wich integrates a smartphone"
\end{quote}
