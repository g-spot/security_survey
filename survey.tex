...
There is a discovery phase and there may be addition or less steps depending on the Encryption mode which was chosen. Mode 0 provides no encryption (early BT versions). Mode 1 provides direct communication encryption but no broadcast encryption. Mode 3 encrypts all traffic \cite{DBLP:journals/ijnsec/Lackner13}. 
\\
\\
