...
Hardware level: \textbf{Signal jamming:} \emph{EnGarde} - rule based signal jamming as a protection mechanism \cite{DBLP:conf/mobisys/GummesonPGTZ13}
...
The topic is not new but still relevant. Recent applications are wearables like fitness wristbands or watches. \\
...
\subsubsection{attacks till Bluetooth 2.1}

\subsubsection{Latest attacks}
